...
//       // // Nytt försöker få igång filter/sort igen:
...
//   const filterPriority = document.getElementById("habit-filter-priority");
...
//   const prioritySortBtn = document.getElementById("habit-priority-sort-btn");
...
// // KODEN ÖVER FINNS I MAIN - INNAN JAG LYCKADES LÖSA FILTER/SORT


// // FUNGERANDE KOD MED FIXAD FILTER/SORT 7 mars 02.22 - SKA ANVÄNDAS & UPP I MAIN:
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  filteredHabits.sort((a, b) => repetitionsSortAscending ? a.repetitions - b.repetitions : b.repetitions - a.repetitions);
  ...
  filteredHabits.forEach(habit => {
    ...
    habitCard.classList.add("habit-card");
        ...
        habitCard.querySelector(".edit-btn").addEventListener("click", function() {
          openPopup(habit, true);
        });
    
        habitCard.querySelector(".delete-btn").addEventListener("click", function() {
          const habitId = parseInt(this.getAttribute("data-id"));
          habits = habits.filter(habit => habit.id !== habitId);
          localStorage.setItem("habits", JSON.stringify(habits));
          renderHabits();
    ...
    document.getElementById("habit-filter-priority").addEventListener("change", function() {
      currentFilterPriority = this.value;
      renderHabits();
  });
  document.getElementById("habit-sort-btn").addEventListener("click", function() {
    repetitionsSortAscending = !repetitionsSortAscending;
    renderHabits();
});
document.getElementById("habit-priority-sort-btn").addEventListener("click", function() {
  prioritySortAscending = !prioritySortAscending;
  habits.sort((a, b) => prioritySortAscending ? a.priority.localeCompare(b.priority) : b.priority.localeCompare(a.priority));
  renderHabits();
});
