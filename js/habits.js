...
document.addEventListener("DOMContentLoaded", function () {
   ...
   `;
        ...
        if (habit.category === "Workout"){
          habitIcon.innerHTML = `<img src="/images/habits/habits-workout.svg" alt="Workout icon">`;
        } else if (habit.category === "Study"){
          habitIcon.innerHTML = `<img src="/images/habits/habits-study.svg" alt="Study icon">`;
        } else if (habit.category === "Clean"){
          habitIcon.innerHTML = `<img src="/images/habits/habits-clean.svg" alt="Cleaning icon">`;
        } else{
          habitIcon.innerHTML = `<img src="/images/habit-no-category.svg" alt="Default icon">`;
        }
      });
